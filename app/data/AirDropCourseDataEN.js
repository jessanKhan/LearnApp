...
var COURSES_DATA_EN = [
    {
      ...
      topic_details: [
        ...
        },
        {
            ...
            topic_item_detalis: `<Text style={{font-weight:Bold}}>Currently, there are two main methods to realize an airdrop</Text> \n <Text style={{font-weight:Bold}}>Method 1.</Text> The holders of a particular cryptocurrency can receive free tokens. The distribution of tokens is in correlation with the number of coins in user’s wallet. Tokens are sent automatically to wallet addresses.
