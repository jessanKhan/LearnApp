...
// import EncryptionTechnologies from './EncryptionTechnologies';

// const EncryptionTechnologiesIndex = props => {
//   return (
//     <View style={styles.screen}>
//       <EncryptionTechnologies {...props} />
//     </View>
//   );
// }
...
// export default EncryptionTechnologiesIndex;

//used Class components for maptostateprops
...
class EncryptionTechnologiesIndex extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      <View style={styles.screen}>
        <EncryptionTechnologies {...this.props} />
      </View>
    );
  }
}
...
export default connect(mapStateProps)(EncryptionTechnologiesIndex);
