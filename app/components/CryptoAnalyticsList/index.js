...
const CryptoAnalyticsListIndex = props => {
    return (
        <View style={styles.screen}>
            <CryptoAnalyticsList {...props} />
        </View>
    )
}
...
export default CryptoAnalyticsListIndex;
...
// class CryptoAnalyticsListIndex extends React.Component {
...
//         return (
//             <View style={styles.screen}>
//                 <CryptoAnalyticsList {...this.props} />
//             </View>
//         )
//     }
// }
...
// export default connect(mapStateProps)(CryptoAnalyticsListIndex);