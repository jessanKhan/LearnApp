...
import MinersCompendium from './MinersCompendium';
import {connect} from 'react-redux';
import {homeDataLoad, homeDataRefresh} from '../../actions/homeAction';

class MinersCompendiumIndex extends React.Component {
  constructor(props) {
    super(props);
...
export default connect(mapStateProps)(MinersCompendiumIndex);
